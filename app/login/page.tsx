      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl shadow-xl p-8 border border-border">
          <div className="mb-8">
            ...
            <p className="text-foreground/60 font-medium">Sign in to your MedGuide account</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {message && (
              <div
                className={`p-4 rounded-lg font-medium ${message.includes("Welcome") ? "bg-primary/10 text-primary" : "bg-accent/10 text-accent"}`}
              >
                {message}
              </div>
            )}
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <p className="text-center text-foreground/60 font-medium">
              ...
              <Link href="/signup" className="text-primary hover:text-primary/90 font-semibold transition">
                Sign up
              </Link>
            </p>
          </div>
